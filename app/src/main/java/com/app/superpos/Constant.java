...
public class Constant {
    ...
    public static final String BASE_URL = "https://bandungtech.my.id/superpos/api/";

    //For retrofit base url must end with /
    public static final String PRODUCT_IMAGE_URL = "https://bandungtech.my.id/superpos/product_images/";
